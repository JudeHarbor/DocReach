...
import 'doctor_sign_up_model.dart';
export 'doctor_sign_up_model.dart';

class DoctorSignUpWidget extends StatefulWidget {
  const DoctorSignUpWidget({super.key});

  static String routeName = 'DoctorSignUp';
  static String routePath = '/doctorSignUp';

  @override
  State<DoctorSignUpWidget> createState() => _DoctorSignUpWidgetState();
}

class _DoctorSignUpWidgetState extends State<DoctorSignUpWidget>
    with TickerProviderStateMixin {
  late DoctorSignUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorSignUpModel());
            ...
            children: [
              Align(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/DocReach__1_-removebg-preview.png',
                    width: 200.0,
                    height: 150.0,
                    fit: BoxFit.cover,
                  ),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed(
                                  DoctorProfileSetupWidget.routeName,
